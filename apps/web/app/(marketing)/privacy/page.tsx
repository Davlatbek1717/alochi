...
export const metadata: Metadata = {
  ...
  description: "Adouptivo maxfiylik siyosati — shaxsiy ma'lumotlaringizni qanday yig'ishimiz, ishlatishimiz va himoya qilishimiz.",
};
        ...
        <div className="mt-10 prose prose-slate max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-[#475569] leading-relaxed">
              Adouptivo (ilgari "A'lochi") — o'quv markazlari uchun SaaS ta'lim platformasi.
