...
const QA = [
  {
    ...
    a: "A'lojon PWA sifatida har qanday smartfon (iOS, Android), planshet va kompyuterda ishlaydi. Bola asosan telefonidan kiradi — tezda yuklanadi va offline rejimda ham asosiy darslarni ochadi.",
  },
  {
