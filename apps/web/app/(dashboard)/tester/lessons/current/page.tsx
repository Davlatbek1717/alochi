...
/**
 * Tester "current lesson" entry point.
 *
 * Resolves the next available lesson via GET /lessons/next and redirects
 * to the shared lesson runner at /student/lessons/[id]. The runner is
 * role-agnostic for testers — they get the same XP/progress flow as
 * regular students (Phase 11 student-clone parity).
 */
export default function TesterCurrentLessonPage() {
    ...
    return (
      <div className="min-h-full bg-[#f7f4ef] flex items-center justify-center p-6">
        <div className="bg-white rounded-[24px] border-[1.5px] border-[#ede9e1] p-10 text-center max-w-sm w-full space-y-4">
          ...
          <div>
            <p className="text-xl font-bold text-[#0f172a]">Barcha sinov darslari tugallandi!</p>
