...
const LESSONS: LessonSpec[] = [
  ...
  // ── orderNumber 61 — STEP 56 — "are not" (C) ────────────────────────────────
  {
    ...
    components: [
      ...
      ...topicSentenceBlock({ uz: 'Biz Polshadan emasmiz', en: 'We are not Polish', words: ['We', 'are', 'not', 'Polish'] }),
      ...
      matchPairs([
        { left: 'We are not Polish', right: 'Biz Polshadan emasmiz' },
  ...
  // ── orderNumber 68 — STEP 62 — "is not 2" (C) ───────────────────────────────
  {
    ...
    components: [
      ...
      ...topicSentenceBlock({ uz: 'U Sherzod emas', en: 'He is not Sherzod', words: ['He', 'is', 'not', 'Sherzod'] }),
      ...topicSentenceBlock({ uz: "U qo'l soati emas", en: 'It is not a watch', words: ['It', 'is', 'not', 'a', 'watch'] }),
      ...topicSentenceBlock({ uz: 'Uchqun huquqshunos emas', en: 'Uchqun is not a lawyer', words: ['Uchqun', 'is', 'not', 'a', 'lawyer'] }),
      ...topicSentenceBlock({ uz: 'Dilnoza yigirmada emas', en: 'Dilnoza is not twenty', words: ['Dilnoza', 'is', 'not', 'twenty'] }),
      ...
      matchPairs([
        { left: 'He is not Sherzod', right: 'U Sherzod emas' },
        { left: 'It is not a watch', right: "U qo'l soati emas" },
        { left: 'Uchqun is not a lawyer', right: 'Uchqun huquqshunos emas' },
        { left: 'Look at the wall', right: 'Devorga qarang' },
        { left: 'The clock is slow', right: 'Soat orqada qolyapti' },
      ]),
      mcq([
        { text: "'Dilnoza is not twenty' — bu nima ma'noda?", options: ['Dilnoza yigirma yoshda', 'Dilnoza yigirmada emas', "Dilnoza o'n yoshda", "Dilnoza o'ttizda emas"], correct: 1 },
  ...
  // ── orderNumber 70 — STEP 64 — "are not 2" (C) ─────────────────────────────
  {
    ...
    components: [
      ...
      ...topicSentenceBlock({ uz: "Aziz va Miron do'stlar emas", en: 'Aziz and Miron are not friends', words: ['Aziz', 'and', 'Miron', 'are', 'not', 'friends'] }),
      ...topicSentenceBlock({ uz: 'Sabina va Aziza sinfdoshlar emas', en: 'Sabina and Aziza are not classmates', words: ['Sabina', 'and', 'Aziza', 'are', 'not', 'classmates'] }),
      ...
      matchPairs([
        ...
        { left: 'Aziz and Miron are not friends', right: "Aziz va Miron do'stlar emas" },
        { left: 'Walk slowly now', right: 'Endi sekin yur' },
        { left: 'Catch the ball', right: "To'pni tutib ol" },
      ]),
      mcq([
        { text: "'Sabina and Aziza are not classmates' — bu nima ma'noda?", options: ['Sabina va Aziza sinfdoshlar', 'Sabina va Aziza sinfdoshlar emas', "Ular do'stlar emas", "Ular o'quvchilar emas"], correct: 1 },
  ...
  // ── orderNumber 73 — STEP 67 — "am not 3" (C) ───────────────────────────────
  {
    ...
    components: [
      ...
      ...topicSentenceBlock({ uz: 'Men Varshavadan emasman', en: 'I am not from Warsaw', words: ['I', 'am', 'not', 'from', 'Warsaw'] }),
      ...topicSentenceBlock({ uz: 'Men muhandis emasman', en: 'I am not an engineer', words: ['I', 'am', 'not', 'an', 'engineer'] }),
      ...topicSentenceBlock({ uz: 'Men Saymin emasman', en: 'I am not Simon', words: ['I', 'am', 'not', 'Simon'] }),
      ...
      matchPairs([
        { left: 'I am not from Warsaw', right: 'Men Varshavadan emasman' },
        { left: 'I am not an engineer', right: 'Men muhandis emasman' },
        { left: 'I am not Simon', right: 'Men Saymin emasman' },
  ...
  // ── orderNumber 75 — STEP 69 — "is not 3" (C) ───────────────────────────────
  {
    ...
    components: [
      mcq([
        {
          ...
          options: ['Sardor am not a boxer', 'Sardor is not a boxer', 'Sardor are not a boxer', 'Sardor not boxer'],
          correct: 1,
        },
      ]),
      ...topicSentenceBlock({ uz: 'Sardor bokschi emas', en: 'Sardor is not a boxer', words: ['Sardor', 'is', 'not', 'a', 'boxer'] }),
      ...topicSentenceBlock({ uz: 'Mushuk aqlli emas', en: 'Cat is not clever', words: ['Cat', 'is', 'not', 'clever'] }),
      ...topicSentenceBlock({ uz: 'Dilshoda shifokor emas', en: 'Dilshoda is not a doctor', words: ['Dilshoda', 'is', 'not', 'a', 'doctor'] }),
      ...
      matchPairs([
        { left: 'Sardor is not a boxer', right: 'Sardor bokschi emas' },
        { left: 'Cat is not clever', right: 'Mushuk aqlli emas' },
        { left: 'Dilshoda is not a doctor', right: 'Dilshoda shifokor emas' },
  ...
  // ── orderNumber 77 — STEP 71 — Composition "My course" (D) ─────────────────
  {
    ...
    components: [
      ...
      fillBlank('My name is ___.', 'Kamola', ['Kamola', 'Sardor', 'Dilnoza', 'Aziz']),
      fillBlank('My surname is ___.', 'Yusupova', ['Yusupova', 'Karimov', 'Rashidova', 'Toshmatov']),
      fillBlank('I am ___ years old.', 'twelve', ['ten', 'eleven', 'twelve', 'thirteen']),
      fillBlank('I am from ___.', 'Bukhara', ['Bukhara', 'Tashkent', 'Samarkand', 'Namangan']),
      fillBlank('Javohir Hakimov is my ___.', 'teacher', ['teacher', 'friend', 'coach', 'parent']),
      ...
      translate('Mening ismim Kamola.', 'My name is Kamola'),
      translate('Men Buxorodanman.', 'I am from Bukhara'),
      translate("Javohir Hakimov mening o'qituvchim.", 'Javohir Hakimov is my teacher'),
      ...
      wordOrder([
        ...
        { words: ['teacher', 'my', 'is', 'Hakimov', 'Javohir'], correct: 'Javohir Hakimov is my teacher' },
      ...
      speakSentence('Javohir Hakimov is my teacher', 70),
      speakSentence('The course has 500 steps', 70),
      speakSentence('I can go to Samarkand', 70),
      speakSentence('I can go to Khiva', 70),
      // Comprehension MCQ
      mcq([
        ...
        { text: "O'qituvchining ismi-familiyasi:", options: ['Sardor Karimov', 'Aziz Toshmatov', 'Javohir Hakimov', 'Dilshod Yusupov'], correct: 2 },
      ]),
      speakWords(
        "I love my A'lochi course. My name is Kamola. My surname is Yusupova. I am twelve years old. I am from Bukhara. Javohir Hakimov is my teacher. The course has 500 steps. I am a pupil at school. My favourite subject is English. My favourite color is red. My favourite car is BMW. I can go to Samarkand. I can go to Khiva.",
        70,
      ),
    ],
  },
  ...
  },
  {
    ...
    components: [
      ...
      speakSentence('We are not Polish', 70),
  ...
  // ── orderNumber 80 — STEP 73 — "are not 3" (C) ──────────────────────────────
  {
    ...
    components: [
      mcq([
        {
          ...
          options: [
            'We is not from Japan',
            'We am not from Japan',
      ...
      ...topicSentenceBlock({ uz: 'Biz Yaponiyadan emasmiz', en: 'We are not from Japan', words: ['We', 'are', 'not', 'from', 'Japan'] }),
      ...topicSentenceBlock({ uz: 'Siz quruvchi emassiz', en: 'You are not a builder', words: ['You', 'are', 'not', 'a', 'builder'] }),
      ...topicSentenceBlock({ uz: 'Odil va Dildora quvnoq emaslar', en: 'Odil and Dildora are not funny', words: ['Odil', 'and', 'Dildora', 'are', 'not', 'funny'] }),
      ...topicSentenceBlock({ uz: "Brovnlar bizning qo'shnimiz emas", en: 'The Browns are not our neighbours', words: ['The', 'Browns', 'are', 'not', 'our', 'neighbours'] }),
      ...
      matchPairs([
        { left: 'We are not from Japan', right: 'Biz Yaponiyadan emasmiz' },
        { left: 'You are not a builder', right: 'Siz quruvchi emassiz' },
        { left: 'Odil and Dildora are not funny', right: 'Odil va Dildora quvnoq emaslar' },
        { left: 'Eat a sweet apple', right: 'Shirin olmani ye' },
        { left: 'I like a banana', right: 'Menga banan yoqadi' },
      ]),
      mcq([
        { text: "'We are not from Japan' — bu nima ma'noda?", options: ['Biz Yaponiyaliklarmiz', 'Biz Yaponiyadan emasmiz', 'Biz quruvchimiz', 'Biz Yaponiyaga boramiz'], correct: 1 },
  ...
  // ── orderNumber 83 — STEP 76 — Topic questions "is" (C) ─────────────────────
  {
    ...
    components: [
      mcq([
        {
          ...
          options: [
            'Are Dilmurod your brother?',
            'Am Dilmurod your brother?',
            'Is Dilmurod your brother?',
            'Do Dilmurod your brother?',
          ],
          correct: 2,
        },
      ]),
      ...topicSentenceBlock({ uz: 'Dilmurod sizning akangizmi?', en: 'Is Dilmurod your brother?', words: ['Is', 'Dilmurod', 'your', 'brother', '?'] }),
      ...topicSentenceBlock({ uz: 'Sharifa yoqimtoymi?', en: 'Is Sharifa cute?', words: ['Is', 'Sharifa', 'cute', '?'] }),
      ...topicSentenceBlock({ uz: 'Reks yuvoshmi?', en: 'Is Rex friendly?', words: ['Is', 'Rex', 'friendly', '?'] }),
      ...
      matchPairs([
        { left: 'Is Dilmurod your brother?', right: 'Dilmurod sizning akangizmi?' },
        { left: 'Is Sharifa cute?', right: 'Sharifa yoqimtoymi?' },
        { left: 'Is Rex friendly?', right: 'Reks yuvoshmi?' },
      ...
      mcq([
        ...
        { text: "'Is Rex friendly?' — to'g'ri tarjima:", options: ['Reks aqllimi?', 'Reks yuvoshmi?', 'Reks sekinmi?', 'Reks kattami?'], correct: 1 },
  ...
  // ── orderNumber 85 — STEP 78 — Topic questions "are" (C) ────────────────────
  {
    ...
    components: [
      ...
      ...topicSentenceBlock({ uz: 'Aziza va Marjona Buxorodanmi?', en: 'Are Aziza and Marjona from Bukhara?', words: ['Are', 'Aziza', 'and', 'Marjona', 'from', 'Bukhara', '?'] }),
      ...topicSentenceBlock({ uz: 'Dilshod va Aziz kelishgan qomatlimi?', en: 'Are Dilshod and Aziz well-built?', words: ['Are', 'Dilshod', 'and', 'Aziz', 'well-built', '?'] }),
      ...
      matchPairs([
        ...
        { left: 'Are Aziza and Marjona from Bukhara?', right: 'Aziza va Marjona Buxorodanmi?' },
      ...
      mcq([
        ...
        { text: "Quyidagilardan qaysi savol to'g'ri tuzilgan?", options: ['Is Dilshod and Aziz well-built?', 'Am Dilshod and Aziz well-built?', 'Are Dilshod and Aziz well-built?', 'Do Dilshod and Aziz well-built?'], correct: 2 },
      ]),
    ],
  },
